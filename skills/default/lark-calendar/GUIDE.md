...
- 默认档位: 基础档默认安装
- 仓库目录: `skills/default/lark-calendar`
- 安装后目录: `~/.openclaw/skills/lark-calendar`
...
## 4. 推荐提问方式
- 请使用 lark-calendar 帮我处理当前任务。
- 如果 lark-calendar 需要额外配置，请先告诉我缺少什么。

## 5. 手动验证
```bash
ls -la ~/.openclaw/skills/lark-calendar
```
