...
| `tavily-search` | `TAVILY_API_KEY` | `browser`, `python` | `medium` |
...
| `dual-axis-skill-reviewer` | 无 | 无 | `low` |
...
| `alphaear-sentiment` | 无 | `python` | `medium` |
...
| `edge-hint-extractor` | 无 | `node` | `medium` |
...
| `finance-data` | 无 | `mcp`, `python` | `medium` |
